        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Nama Pelanggan</label>
                      <input value="{{old('nama_pelanggan')}}" type="text" class="form-control" name="nama_pelanggan" placeholder="Nama Pelanggan">
                  ...
                  @enderror
                    ...
                    <div class="form-group">
                          ...
                          <label for="exampleInputEmail1">No Telepon</label>
                              <input value="{{old('no_telepon')}}" type="number" class="form-control" name="no_telepon" placeholder="No Telepon">
                              @error('no_telepon')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Waktu Reservasi</label>
                              <input value="{{old('waktu')}}" type="date" class="form-control" name="waktu" placeholder="Waktu Reservasi">
                              @error('waktu')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
